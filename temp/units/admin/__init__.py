...
from .myp import (
    ...
    MypAtlDevelopIduModelAdmin,
    MypReflectionPostIduModelAdmin
)

from .pyp import (
    TransdisciplinaryThemeModelAdmin,
    PypKeyConceptModelAdmin,
    PypAtlGroupModelAdmin,
    PypAtlSkillModelAdmin,
    PypUnitPlannerModelAdmin,
