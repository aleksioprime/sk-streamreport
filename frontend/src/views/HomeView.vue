      ...
      <div class="col-md card m-2">
        <div class="card-body">
          <div class="my-2">
            ...
            <div>Дедлайн рассылки репортов: <a href="https://www.google.com/calendar/render?action=TEMPLATE&text=Дедлайн рассылки репортов&dates=20240115T120000Z/20240115T120000Z&details=Необходимо разослать все репорты родителям студентов&sf=true&output=xml" target="_blank">15.01.2024</a></div>
          </div>
          <div class="my-2">
            <h5>Изменения версии от 10.01.2024:</h5>
            <div>
              <ul>
                <li>Исправлены ошибки формирования файла репорта</li>
                <li>Исправлены ошибки добавления репорта без периода</li>
                <li>Добавлена возможность редактирования репортов администрацией Гимназии</li>
                <li>Скорректированы шаблоны репортов начальной, средней и старшей школы</li>
                <li>Добавлен лоадер загрузки файла репорта</li>
                <li>Добавлен лоадер загрузки карточек репортов</li>
                <li>Отменён автоматический вывод карточек репортов при обновлении страницы</li>
              </ul>
            </div>
          </div>
          <div class="my-2">
