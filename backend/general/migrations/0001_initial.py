    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('gender', models.CharField(blank=True, choices=[('male', 'Мужчина'), ('female', 'Женщина'), ('None', 'Не указан')], default='none', max_length=6, null=True, verbose_name='Пол')),
                ('photo', models.ImageField(blank=True, null=True, upload_to='member_photos', verbose_name='Фотография')),
                ('dnevnik_token', models.CharField(blank=True, max_length=255, null=True, verbose_name='Токе доступа в Дневник')),
                ('dnevnik_id', models.CharField(blank=True, max_length=40, null=True, verbose_name='ID пользователя Дневника')),
