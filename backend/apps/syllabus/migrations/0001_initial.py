# Generated by Django 4.2.4 on 2023-11-04 23:25
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('group_fgos', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='subject', to='syllabus.fgossubjectgroup', verbose_name='Предметная область в РФ')),
                ('group_ib', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='subject', to='syllabus.ibsubjectgroup', verbose_name='Предметная группа в IB')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('syllabus', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='syllabus_subject_hours', to='syllabus.syllabus', verbose_name='Учебный план')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('group', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='specific_disciplines', to='syllabus.ibsubjectgroup', verbose_name='Предметная группа')),
            ],
            options={
