    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(max_length=64, verbose_name='Название')),
                ('name_rus', models.CharField(blank=True, max_length=64, null=True, verbose_name='Название на рус. языке')),
                ('cluster', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='groups', to='pyp.pypatlcluster', verbose_name='Кластер ATL')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('transdisciplinary_theme', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='pyp_unitplans', to='pyp.transdisciplinarytheme', verbose_name='Трансдисциплинарная тема')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(max_length=255, verbose_name='Название')),
                ('name_rus', models.CharField(max_length=255, null=True, verbose_name='Название на рус. языке')),
                ('cluster', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='skills', to='pyp.pypatlcluster', verbose_name='Кластер ATL')),
                ('group', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='skills', to='pyp.pypatlgroup', verbose_name='Группа ATL')),
            ],
            options={
