...
urlpatterns = [
    ...
    path('pyp/atl', PypAtlSkillViewSet.as_view({'get': 'list'})),
    ...
    path('pyp/unit/inquiry/<int:pk>', PypLinesOfInquiryViewSet.as_view({'put': 'update', 'delete': 'destroy'})),
    path('pyp/unit/relatedconcept', PypRelatedConceptViewSet.as_view({'get': 'list', 'post': 'create'})),
    path('pyp/unit/relatedconcept/<int:pk>', PypRelatedConceptViewSet.as_view({'put': 'update', 'delete': 'destroy'})),
    path('pyp/unit/atl', PypAtlDevelopViewSet.as_view({'get': 'list', 'post': 'create'})),
    path('pyp/unit/atl/<int:pk>', PypAtlDevelopViewSet.as_view({'put': 'update', 'delete': 'destroy'})),
]