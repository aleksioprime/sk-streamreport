...
class MypObjective(models.Model):
    ...
    group = models.ForeignKey('syllabus.IbSubjectGroup', verbose_name=_("Предметная группа IB"), on_delete=models.SET_NULL, null=True, related_name="myp_objectives")
    class Meta:
...
class Strand(models.Model):
    ...
    name = models.CharField(max_length=255, verbose_name=_("Название"))
    name_rus = models.CharField(max_length=255, verbose_name=_("Название на рус. языке"), null=True, blank=True)
    objective = models.ForeignKey('units.MypObjective', verbose_name=_("Предметная цель"), on_delete=models.SET_NULL, null=True, related_name="strands")
    class Meta:
...
class StrandLevel(models.Model):
    ...
    level = models.ForeignKey('units.EducationalLevel', verbose_name=_("Уровень в IB"), on_delete=models.SET_NULL, null=True, related_name="strand_levels")
    strand = models.ForeignKey('units.Strand', verbose_name=_("Стрэнд"), on_delete=models.SET_NULL, null=True, related_name="strand_levels")
    class Meta:
...
class AchievementLevel(models.Model):
    ...
    strand_level = models.ForeignKey('units.StrandLevel', verbose_name=_("Предметная цель"), on_delete=models.CASCADE, null=True, related_name="achieve_levels")
...
class MypAim(models.Model):
    ...
    name_rus = models.CharField(max_length=255,verbose_name=_("Название на рус. языке"), null=True, blank=True)
    group = models.ForeignKey('syllabus.IbSubjectGroup', verbose_name=_("Предметная группа"), on_delete=models.SET_NULL, null=True, related_name="myp_aims")
    class Meta:
...
class MypKeyConceptOfSubjects(models.Model):
    ...
    key_concept = models.ForeignKey('units.MypKeyConcept', verbose_name=_("Ключевой концепт"), on_delete=models.SET_NULL, null=True, related_name="subjects_recomends")
    group = models.ForeignKey('syllabus.IbSubjectGroup', verbose_name=_("Предметная группа"), on_delete=models.SET_NULL, null=True, related_name="key_concepts_recomends")
...
class MypRelatedConcept(models.Model):
    ...
    description = models.TextField(verbose_name=_("Описание"), null=True, blank=True)
    description_rus = models.TextField(verbose_name=_("Описание на рус. языке"), null=True, blank=True)
    disciplines = models.ManyToManyField('syllabus.IbDiscipline', verbose_name=_("Специальные дисциплины"), related_name="related_concepts")
    class Meta:
...
class MypProfileDevelop(models.Model):
    ...
    profile = models.ForeignKey('units.LearnerProfile', verbose_name=_("Профиль студента"), on_delete=models.CASCADE, related_name="myp_profiles")
    description = models.TextField(verbose_name=_("Описание"), null=True, blank=True)
