    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('level', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='strand_levels', to='myp.educationallevel', verbose_name='Уровень в IB')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('interdisciplinary', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='myp_unitplans', to='myp.mypunitplannerinterdisciplinary', verbose_name='Междисциплинарный юнит')),
                ...
                ('level', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='myp_unitplans', to='myp.educationallevel', verbose_name='Образовательный уровень')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('unit', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='reflection_posts', to='myp.mypunitplannerinterdisciplinary', verbose_name='Междисциплинарный юнит MYP')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('unit', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='reflection_posts', to='myp.mypunitplanner', verbose_name='Юнит MYP')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('description', models.TextField(blank=True, null=True, verbose_name='Описание')),
                ('profile', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='myp_profiles', to='ibo.learnerprofile', verbose_name='Профиль студента')),
                ('unit', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='profile_develops', to='myp.mypunitplanner', verbose_name='Юнит MYP')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('unit', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='inquiry_questions', to='myp.mypunitplannerinterdisciplinary', verbose_name='Междисциплинарный юнит MYP')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('unit', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='atl_develops', to='myp.mypunitplannerinterdisciplinary', verbose_name='Междисциплинарный юнит MYP')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('strand_level', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='achieve_levels', to='myp.strandlevel', verbose_name='Предметная цель')),
            ],
            options={
