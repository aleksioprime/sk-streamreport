...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='pyp_unitplans', to='units.transdisciplinarytheme', verbose_name='Трансдисциплинарная тема'),
        ),
        migrations.AddField(
            model_name='pypunitplanner',
            name='year',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('hours', models.PositiveSmallIntegerField(default=0, verbose_name='Кол-во часов')),
                ('integrated_forms', models.TextField(blank=True, null=True, verbose_name='Формы интеграции')),
